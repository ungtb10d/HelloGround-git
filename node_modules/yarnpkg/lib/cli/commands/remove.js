...
let run = exports.run = (() => {
  var _ref = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (config, reporter, flags, args) {
    ...
    const install = new (_install || _load_install()).Install(flags, config, new (_index2 || _load_index2()).NoopReporter(), lockfile);
    const rootManifests = yield install.getRootManifests();
    const manifests = [];
    ...
    // save manifests
    yield install.saveRootManifests(rootManifests);
