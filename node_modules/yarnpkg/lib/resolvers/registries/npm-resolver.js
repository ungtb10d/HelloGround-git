  ...
  static findVersionInRegistryResponse(config, range, body) {
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      ...
      if (satisfied) {
        ...
        throw new (_errors || _load_errors()).MessageError(`Couldn't find any versions for ${ body.name } that matches ${ range }. ` + `Possible versions: ${ Object.keys(body.versions).join(', ') }`);
      }
    })();
  }
