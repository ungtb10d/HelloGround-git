...
let copyBulk = exports.copyBulk = (() => {
  var _ref3 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (queue, _events) {
    ...
    yield (_promise || _load_promise()).queue(fileActions, function (data) {
...
let readJson = exports.readJson = (() => {
  var _ref5 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (loc) {
    ...
    try {
      return (0, (_map || _load_map()).default)(JSON.parse(stripBOM(file)));
    } catch (err) {
...
let find = exports.find = (() => {
  var _ref6 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (filename, dir) {
  ...
  return function find(_x9, _x10) {
    return _ref6.apply(this, arguments);
  };
})();

let symlink = exports.symlink = (() => {
  var _ref7 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (src, dest) {
    try {
  ...
  return function symlink(_x11, _x12) {
    return _ref7.apply(this, arguments);
  };
})();

let walk = exports.walk = (() => {
  var _ref8 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (dir, relativeDir) {
  ...
  return function walk(_x13, _x14, _x15) {
